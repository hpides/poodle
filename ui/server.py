...
_PRETTY_NAMES = {
    ...
    Model.CLAUDE_HAIKU_4_5:      "Claude Haiku 4.5",
    Model.CLAUDE_SONNET_5:       "Claude Sonnet 5",
    Model.CLAUDE_OPUS_5:         "Claude Opus 5",
...
_PROVIDERS = {
    ...
    Model.GEMINI_2_5_FLASH_LITE: "Google",
    Model.GEMINI_2_5_FLASH:      "Google",
    Model.GEMINI_2_5_PRO:        "Google",
    Model.GEMINI_3_FLASH_PREVIEW:"Google",
    Model.CLAUDE_HAIKU_4_5:      "Anthropic",
    Model.CLAUDE_SONNET_5:       "Anthropic",
    Model.CLAUDE_OPUS_5:         "Anthropic",
    Model.GPT_4_1:               "OpenAI",
    Model.GPT_4_1_MINI:          "OpenAI",
    Model.GPT_4_1_NANO:          "OpenAI",
    Model.GPT_5_5:               "OpenAI",
    Model.GPT_5_4_MINI:          "OpenAI",
